...
class Messages:
    ...
    USER_CANNOT_RESPOND_TWICE = "❗️ Вы не можете откликнуться несколько раз на одну заявку"
    ...
    USER_IS_NO_REGISTERED = "❗️ Вы не зарегистрированы в системе. Пожалуйста, отправьте команду /start в личные сообщения бота для начала работы."
    ...
    USER_MENTION_PROBLEM = """⚠️ Не удалось создать упоминание c вашим именем.
